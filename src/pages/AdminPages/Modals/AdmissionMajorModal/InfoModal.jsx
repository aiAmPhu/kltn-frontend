...
import { FaTimes, FaIdCard, FaTag, FaFileAlt, FaInfoCircle, FaLayerGroup, FaClipboardList } from "react-icons/fa";
            ...
            <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-2xl w-full max-w-lg sm:max-w-xl lg:max-w-2xl max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex-1">
                                        <p className="text-sm font-medium text-gray-600 mb-1">Mã ngành xét tuyển</p>
                            ...
                            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex-1">
                                        <p className="text-sm font-medium text-gray-600 mb-1">Tên ngành xét tuyển</p>
                            ...
                            {major.majorCombination && major.majorCombination.length > 0 ? (
                                <div className="space-y-3">
                                    <p className="text-sm font-medium text-gray-600 mb-3">
                                        Danh sách tổ hợp ({major.majorCombination.length})
                                    </p>
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                        {major.majorCombination.map((combo, index) => (
                                            <div
                                                key={index}
                                                className="bg-blue-100 text-blue-800 px-3 py-2 rounded-lg text-sm font-medium text-center"
                                            >
                                                {combo}
                                            </div>
                                        ))}
                                ...
                                <div className="text-center py-4">
                                    <p className="text-gray-500 text-sm">Không có tổ hợp xét tuyển</p>
                                </div>
                            )}
                        </div>
                    </div>
                ...
                <div className="sticky bottom-0 bg-white z-10 flex justify-end pt-6 border-t border-gray-200 mt-6">
                    <button
                        ...
                        title="Đóng chi tiết ngành xét tuyển"
                    >
