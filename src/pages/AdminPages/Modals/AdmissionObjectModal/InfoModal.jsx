...
import { FaTimes, FaIdCard, FaTag, FaFileAlt, FaPercent, FaInfoCircle, FaClipboardList } from "react-icons/fa";
            ...
            <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-2xl w-full max-w-lg sm:max-w-xl lg:max-w-2xl max-h-[90vh] overflow-y-auto">
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex-1">
                                        <p className="text-sm font-medium text-gray-600 mb-1">Mã đối tượng ưu tiên</p>
                            ...
                            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex-1">
                                        <p className="text-sm font-medium text-gray-600 mb-1">Tên đối tượng ưu tiên</p>
                            ...
                            <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                                <div className="flex items-center gap-3">
                                    <div className="w-10 h-10 bg-orange-100 rounded-lg flex items-center justify-center">
                                        <FaPercent className="text-orange-600 text-lg" />
                                    </div>
                                    <div className="flex-1">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
                            <p className="text-gray-700 whitespace-pre-wrap leading-relaxed">
                                {object.objectDescription || "Không có mô tả"}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="sticky bottom-0 bg-white z-10 flex justify-end pt-6 border-t border-gray-200 mt-6">
                    <button
                        ...
                        title="Đóng chi tiết đối tượng ưu tiên"
                    >
