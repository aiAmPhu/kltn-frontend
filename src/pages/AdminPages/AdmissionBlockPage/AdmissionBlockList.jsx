...
const AdmissionBlockList = ({ admissionBlocks = [], setAdmissionBlocks }) => {
    ...
    const filteredBlocks = admissionBlocks.filter((block) =>
                                    ...
                                    currentBlocks.map((block) => (
                                        <tr key={block.admissionBlockId} className="hover:bg-gray-50">
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                <div className="text-sm font-medium text-gray-900">{block.admissionBlockId}</div>
                                            </td>
                                            <td className="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="text-sm text-gray-500">
                                                    {[block.admissionBlockSubject1, block.admissionBlockSubject2, block.admissionBlockSubject3]
                                                        .filter(Boolean)
                                                        .join(", ")}
                                                </div>
                                            </td>
